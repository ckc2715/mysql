...
function Parser(options) {
  ...
  this._encoding = options.config.encoding || 'BIG5';
  this._paused = false;
}
...
Parser.prototype.parseNullTerminatedString = function () {
  var end = this._nullByteOffset();
  var __buffer = this._buffer.slice(this._offset, end);
  var value = iconv.decode(__buffer, this._encoding)
  this._offset = end + 1;
...
Parser.prototype.parseString = function (length) {
  ...
  var __buffer = this._buffer.slice(offset, end);
  var value = iconv.decode(__buffer, this._encoding)
  this._offset = end;
  return value;
};
